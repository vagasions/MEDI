...
TAGS = [
    ...
    ("XS-711", "XV-701 열림 지령", ""), ("XS-712", "XV-701 열림 리미트(ZSO)", ""), ("XS-713", "XV-701 닫힘 리미트(ZSC)", ""),
    ("KT-714", "XV-701 스트로크 시간", "s"), ("PT-715", "XV-701 구동 공기압", "kg/cm2"),
...
BASE = {
    ...
    "XS-711": (1, 0), "XS-712": (1, 0), "XS-713": (0, 0), "KT-714": (8, 0.4), "PT-715": (6.3, 0.06),
